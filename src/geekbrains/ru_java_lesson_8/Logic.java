    ...
    private static void go() {
        ...
        if (checkWinLines(DOT_X, DOTS_TO_WIN)) {
            ...
            if(Logic.isFinishedGame){
                JOptionPane.showMessageDialog(frame, "Игра окончена, игрок победил!");
            }
            return;
        }
        if (isFull()) {
            ...
            if(Logic.isFinishedGame){
                JOptionPane.showMessageDialog(frame, "Игра окончена, ничья!");
            }
            return;
        }
        ...
        if (checkWinLines(DOT_O, DOTS_TO_WIN)) {
            ...
            if(Logic.isFinishedGame){
                JOptionPane.showMessageDialog(frame, "Игра окончена, компьютер победил!");
            }
            return;
        }
        if (isFull()) {
